...
export const loadInvitation = <ThrowOnError extends boolean = false>(
  options: Options<LoadInvitationData, ThrowOnError>,
): RequestResult<LoadInvitationResponses, LoadInvitationErrors, ThrowOnError> =>
  (options.client ?? client).get<
    LoadInvitationResponses,
    LoadInvitationErrors,
    ThrowOnError
  >({
    responseValidator: async (data) =>
      await zLoadInvitationResponse.parseAsync(data),
    security: [
      {
        in: "cookie",
        name: "__Host-carry_session",
