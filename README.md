...
The current V1 foundation supports member login, bounded durable Work, independent Machine enrollment, fenced Pi/Codex execution and recovery, and private member Conversations that can directly create shared Work. Product behavior is added through the vertical Nodes in [`docs/implementation.md`](docs/implementation.md); unearned future owners and protocols are intentionally absent.
